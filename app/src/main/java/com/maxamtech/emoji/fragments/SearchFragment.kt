...
import com.maxamtech.emoji.store.StickersDetailsActivity
...
class SearchFragment : Fragment() {
    ...
    private fun init(view: View) {
        ...
        var tagRecyclerView : RecyclerView = view.findViewById(R.id.tagRecycler)
        ...
        tagRecyclerView.addOnItemTouchListener(RecyclerTouchListener(this@SearchFragment.activity!!, tagRecyclerView,
                object : RecyclerTouchListener.ClickListener {
                    override fun onClick(view: View, position: Int) {
                        var intent: Intent = Intent(this@SearchFragment.context, StickersDetailsActivity::class.java)
                        this@SearchFragment.context?.startActivity(intent)
                    }
